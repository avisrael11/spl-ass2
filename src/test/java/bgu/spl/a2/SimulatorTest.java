...
//    }
    ...
    public void testPlaceForTwo(CoursePrivateState course_state, String course_name){
        assertTrue("Two students should be registered to this course" + course_name + " has: " + course_state.getRegistered() + " spots: " + course_state.getAvailableSpots(), course_state.getRegistered() == 2);
    ...
    public void testSigntoPref4(StudentPrivateState student_state, String student_name){
        assertTrue("Should be registered to pref 4 " + student_name,
    ...
    public void testSigntoCourse3or4(StudentPrivateState student_state, String student_name){
        assertTrue("Should be registered to either course pref 4 or pref 3" + student_name,
